...
export default function PlayerStatsScreen() {
  ...
  const mainContent = (
    ...
    >
      {/* Player Header Card */}
      <View style={[styles.headerCard, isWeb && isDesktop && styles.headerCardDesktop]}>
        <View style={styles.headerContent}>
          <Image
            source={{ uri: player?.avatar || 'https://assets.faceit-cdn.net/avatars/defaults/user.png' }}
            style={[styles.avatar, isWeb && isDesktop && styles.avatarDesktop]}
          />
          <View style={styles.playerInfo}>
            <View style={styles.nameRow}>
              <Text style={[styles.nickname, isWeb && isDesktop && styles.nicknameDesktop]}>
            ...
            <View style={styles.badgesRow}>
              ...
              <View style={styles.eloBadge}>
                <Text style={styles.eloText}>{player?.games?.cs2?.faceit_elo || '0'} ELO</Text>
              </View>
            </View>
          </View>
        </View>
      ...
      {/* Stats Section */}
      {stats ? (
        <View style={[styles.statsSection, isWeb && isDesktop && styles.statsSectionDesktop]}>
      ...
      <View style={[styles.historySection, isWeb && isDesktop && styles.historySectionDesktop]}>
